...
public class TestHBaseClient extends BaseTestHBaseClient {
  ...
  public void getRegion96Meta() throws Exception {
    System.out.println(Whitebox.getInternalState(client, "has_root"));
    final Object obj = Whitebox.invokeMethod(client, "getRegion", 
...
//  }
  ...
  @Test
  public void sendRpcToRegion() throws Exception {
    final HBaseRpc rpc = PowerMockito.spy(new GenericRequest(TABLE, KEY));
    
    client.sendRpcToRegion(rpc);
    
    
    PowerMockito.verifyStatic();
    HBaseClient.cannotRetryRequest(rpc);
