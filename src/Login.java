...
public class Login {
  private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(RegionClient.class);
    ...
    private static Login currUser = null;

    public static synchronized void initUserIfNeeded(String loginContextName,
                                                     CallbackHandler callbackHandler)
        throws LoginException {
      if(currUser == null)  {
        currUser = new Login(loginContextName, callbackHandler);
        currUser.startThreadIfNeeded();
      }
    }

    public static synchronized Login getCurrLogin() {
      return currUser;
    }
